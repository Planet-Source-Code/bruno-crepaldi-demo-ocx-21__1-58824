...
Begin VB.UserControl V_UpDown 
   ...
   ScaleHeight     =   2400
   ScaleWidth      =   3645
   ToolboxBitmap   =   "V_UpDown.ctx":0000
   Begin VB.CommandButton Cmd_Up 
      Appearance      =   0  'Flat
      BackColor       =   &H00E0E0E0&
      DownPicture     =   "V_UpDown.ctx":0314
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "V_UpDown"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'=====================================================
' Descrizione.....: Vertical UpDown
' Nome del File ..: V_UpDown
' Data............: 27/11/2004
' Versione........: 1.31
' Sistema.........: Windows
...
Private Sub UserControl_Resize()
  ...
  Cmd_Up.Left = 0
  Cmd_Up.Top = 0
  Cmd_Up.Width = ScaleWidth
   
  Cmd_Down.Left = 0
  Cmd_Down.Top = ScaleHeight - 255
  Cmd_Down.Width = ScaleWidth
  
  LblValue.Left = 0
  LblValue.Top = 240
  LblValue.Width = ScaleWidth
  LblValue.Height = ScaleHeight - (255 * 2)
  
  LblValue.FontSize = LblValue.Height / 22
